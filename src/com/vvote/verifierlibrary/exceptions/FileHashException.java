...
/**
 * Exception used when there is a problem performing a commitment check
 * 
 * @author James Rumble
 * 
 */
public class FileHashException extends Exception {
	 ...
	 */
	private static final long serialVersionUID = -7755503788109549371L;
	 ...
	 */
	public FileHashException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
